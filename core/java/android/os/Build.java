...
public class Build {
    ...
    /**
     * ArtStarOS fingerprint
     * @hide
     */
    public static final String PROP_ARTSTAR_FINGERPRINT = "ro.artstar.fingerprint";

    /**
     * ArtStarOS fingerprint
     * @hide
     */
    public static final String ARTSTAR_FINGERPRINT = SystemProperties.get(PROP_ARTSTAR_FINGERPRINT,
            deriveFingerprint());
